...
PRINTER_IP     = "IP HERE"       # Your printer's local IP address
PRINTER_SERIAL = "SERIAL HERE"     # Your serial number
ACCESS_CODE    = "CODE HERE"           # Found in: Printer screen → Settings → LAN
# ──────────────────────────────────────────────────────────────────────────────
